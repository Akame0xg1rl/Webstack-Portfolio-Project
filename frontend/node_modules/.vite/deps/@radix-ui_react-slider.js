...
var $faa2e61a3361514f$export$472062a354075cee = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  const [slider, setSlider] = (0, import_react2.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setSlider(node)
  );
  const thumbRefs = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
  const valueIndexToChangeRef = (0, import_react2.useRef)(0);
  ...
  const valuesBeforeSlideStartRef = (0, import_react2.useRef)(values);
  ...
  return (0, import_react2.createElement)($faa2e61a3361514f$var$SliderProvider, {
    ...
    values,
    orientation
  }, (0, import_react2.createElement)($faa2e61a3361514f$var$Collection.Provider, {
    scope: props.__scopeSlider
  }, (0, import_react2.createElement)($faa2e61a3361514f$var$Collection.Slot, {
    scope: props.__scopeSlider
  }, (0, import_react2.createElement)(SliderOrientation, _extends({
    ...
    (value, index) => (0, import_react2.createElement)($faa2e61a3361514f$var$BubbleInput, {
      key: index,
...
var $faa2e61a3361514f$var$SliderHorizontal = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  const rectRef = (0, import_react2.useRef)();
  ...
  return (0, import_react2.createElement)($faa2e61a3361514f$var$SliderOrientationProvider, {
    scope: props.__scopeSlider,
    startEdge: isSlidingFromLeft ? "left" : "right",
    endEdge: isSlidingFromLeft ? "right" : "left",
    direction: isSlidingFromLeft ? 1 : -1,
    size: "width"
  }, (0, import_react2.createElement)($faa2e61a3361514f$var$SliderImpl, _extends({
    dir: direction,
...
var $faa2e61a3361514f$var$SliderVertical = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $faa2e61a3361514f$var$SliderImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const { __scopeSlider, onSlideStart, onSlideMove, onSlideEnd, onHomeKeyDown, onEndKeyDown, onStepKeyDown, ...sliderProps } = props;
  const context = $faa2e61a3361514f$var$useSliderContext($faa2e61a3361514f$var$SLIDER_NAME, __scopeSlider);
  return (0, import_react2.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({}, sliderProps, {
    ref: forwardedRef,
...
var $faa2e61a3361514f$export$105594979f116971 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $faa2e61a3361514f$export$a5cf38a7a000fe77 = (0, import_react2.forwardRef)((props, forwardedRef) => {
...
var $faa2e61a3361514f$export$2c1b491743890dec = (0, import_react2.forwardRef)((props, forwardedRef) => {
  const getItems = $faa2e61a3361514f$var$useCollection(props.__scopeSlider);
  const [thumb, setThumb] = (0, import_react2.useState)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setThumb(node)
  );
  const index = (0, import_react2.useMemo)(
  ...
  return (0, import_react2.createElement)($faa2e61a3361514f$var$SliderThumbImpl, _extends({}, props, {
    ref: composedRefs,
    index
  }));
});
var $faa2e61a3361514f$var$SliderThumbImpl = (0, import_react2.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react2.createElement)("span", {
    style: {
      transform: "var(--radix-slider-thumb-transform)",
      position: "absolute",
      [orientation.startEdge]: `calc(${percent}% + ${thumbInBoundsOffset}px)`
    }
  }, (0, import_react2.createElement)($faa2e61a3361514f$var$Collection.ItemSlot, {
    scope: props.__scopeSlider
